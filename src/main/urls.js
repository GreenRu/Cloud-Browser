...
const INTERNAL_PAGES = {
  ...
  'stratus://flights': path.join(__dirname, '..', 'pages', 'flights.html'),
  ...
  // And what everyone else calls a flight.
  'stratus://downloads': path.join(__dirname, '..', 'pages', 'flights.html')
};
